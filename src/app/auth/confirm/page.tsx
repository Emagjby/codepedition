          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            <div className="px-8 py-10">
              <div className="bg-green-50 border-2 border-green-400 rounded-lg p-6 text-center">
                ...
                <h3 className="text-xl font-semibold text-green-700 mb-2">Email Confirmed Successfully!</h3>
                <p className="text-gray-600 mb-6">
                  Your email has been verified and your account is now active. You can now access all features of our platform.
                </p>
